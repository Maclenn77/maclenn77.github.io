const Lead = () => {
    ...
    <div>
      ...
      <section>
      <h6>My work in Social Networks</h6>
      <div class="d-flex justify-content-between">
        <a href="https://github.com/Maclenn77" class='fab fa-github'></a>
        <a href="https:/twitter.com/srjuanpapas" class='fab fa-twitter'></a>
        <a href="http://linkedin.com/juanpaulopereztejada" class='fab fa-linkedin'></a>
        <a href="http://developerz.software" class='fab fa-wordpress'></a>
